...
- 📄 См. таблицу в [Markdown-формате](test_cases/test_cases_phone_country.md)
...
### 🔹 Условие:
Написать тест, который открывает веб-страницу [https://playwright.dev/](https://playwright.dev/) и проверяет что заголовок страницы соответствует ожидаемому значению. Тест необходимо запустить минимум на 2 разных браузерах.
...
📸 Пример вывода в терминале после запуска автотеста:
