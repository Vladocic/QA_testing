...
def show_test_result(sucses_test,fail_test,steps):
    
    f"Успешных тестов {sucses_test}/{steps}\nНеуспешных тестов {sucses_test}/{steps}"
    f"Неуспешных тестов {sucses_test}/{steps}"
